            ...
            <div class="selection fullwidth_col_right">
                ...
                <div class="col_right_wrap" id="col_right_wrap_Bikes">
                    ...
                    <div class="progress_intro">
                        Choose a bike that best suits your needs and lifestyle.
                    </div>
                    ...
                    <form class="select_checkbox_">
                        <fieldset class="checkbox-group">
                            ...
                            <div class="bike_desc bike_desc_hsd" id="bike_desc_hsd">
                                The HSD is ideal for your daily commute to work or may even be configured to carry a young child up to 3yo.
                            </div>

                            <div class="bike_config_desc bike_config_desc_hsd" id="bike_config_desc_hsd">
                              <h6>Popular Configurations for HSD</h6>
									Check out our most popular configurations for the HSD. If one suits your needs, then you’re almost done here.
                            </div>
							
                            <div class="bike_desc bike_desc_gsd"  style="display:none;" id="bike_desc_gsd">
                                The GSD is ideal for your daily commute to work or may even be configured to carry a young child up to 3yo.
                            </div>

                            <div class="bike_config_desc bike_config_desc_gsd" style="display:none;" id="bike_config_desc_gsd">
                              <h6>Popular Configurations for GSD</h6>
									Check out our most popular configurations for the GSD. If one suits your needs, then you’re almost done here.
                            </div>							
				...
				<div class="col_right_wrap col_right_wrap_accessories" id="col_right_wrap_<?php echo $section; ?>"   style="display:none;">
                    ...
                    <div class="progress_intro">
                        Choose the accessories that best suits your needs and the age of your child.
                    </div>
