...
jQuery(document).ready(function( $ ) {
	...
	var do_not_reverse = Array('configure','signup','accessory','operational','operational-zone','about', 'self-checkout-signup', 'book-a-test-ride', 'book-a-consultation', 'manual-checkout');
